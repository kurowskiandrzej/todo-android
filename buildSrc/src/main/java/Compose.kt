object Compose {
    ...
    const val composeMaterialIconsVersion = "1.4.0-beta01"
    ...
    const val materialIcons = "androidx.compose.material:material-icons-extended:$composeMaterialIconsVersion"
